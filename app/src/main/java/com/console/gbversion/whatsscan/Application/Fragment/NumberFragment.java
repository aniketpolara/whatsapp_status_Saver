...
public class NumberFragment extends Fragment {
    public static NumberFragment content(String str, String str2) {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        try {
            ...
            holder.ivCopy.setOnClickListener(new View.OnClickListener() { // from class: com.console.gbversion.whatsscan.Application.Fragment.NumberFragment.1
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    NumberFragment.this.clickOnCopy(sb.toString());
                }
            });
            holder.ivShare.setOnClickListener(new View.OnClickListener() { // from class: com.console.gbversion.whatsscan.Application.Fragment.NumberFragment.2
                @Override // android.view.View.OnClickListener
                public void onClick(View view) {
                    NumberFragment.this.shareOnly(false, sb.toString());
                }
            });
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private class Holder {
        ...
        public Holder(NumberFragment numberFragment, View view) {
            this.txtNumberStyle = (TabView) view.findViewById(R.id.txtNumberStyleId);
